...
/* replace if statement with while statement to repeat until user input proper grade */
...
namespace GradeCalculator
{
  class Program
  {
   ...
   Assignments = Convert.ToDouble(Console.ReadLine());
      while(Assignments>100 || Assignments<0) {
   ...
   ClassParticipation = Convert.ToDouble(Console.ReadLine());
      while(ClassParticipation>100 || ClassParticipation<0) {
